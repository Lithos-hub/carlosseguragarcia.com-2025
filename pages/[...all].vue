...
// SEO metadata
useHead({
  title: "404 - Página no encontrada | Carlos Segura Garcia",
  meta: [
    {
      name: "description",
      content: "La página que buscas no existe en el sistema. Error 404.",
    },
  ],
});

// Tiempo actual para el terminal
...
.glitch {
  ...
  &--text {
    animation:
      glitch-flicker 2.5s ease-in-out infinite,
  ...
  &--description {
    animation:
      glitch-flicker 4s ease-in-out infinite,
  ...
  &--accent {
    animation:
      glitch-flicker 1.5s ease-in-out infinite,
